...
This project is indexed by GitNexus as **fe-mycourse** (4171 symbols, 10398 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
