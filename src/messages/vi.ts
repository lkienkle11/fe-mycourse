...
const messages = {
  ...
  auth: {
    ...
    socialLogin: {
      ...
      discordSignup: "Đăng ký với Discord",
      googleSuccess: "Đăng nhập Google thành công",
      googleCancelled: "Đã hủy đăng nhập Google",
      xSuccess: "Đăng nhập X thành công",
      xCancelled: "Đã hủy đăng nhập X",
      discordSuccess: "Đăng nhập Discord thành công",
      discordCancelled: "Đã hủy đăng nhập Discord",
    },
    email: "Địa chỉ email",
    password: "Mật khẩu",
    fullName: "Họ và tên",
  ...
  instructor: {
    validation: {
      ...
      teachingContentIdeas: "Vui lòng nhập ý tưởng về nội dung cần dạy.",
      teachingContentIdeasMin:
        "Ý tưởng về nội dung cần dạy tối thiểu 50 ký tự.",
      teachingContentIdeasMax: "Ý tưởng về nội dung cần dạy tối đa 500 ký tự.",
    ...
    application: {
      ...
      sidebar: {
        ...
        step2: "Mô tả bản thân, kinh nghiệm và ý tưởng khóa học",
        ...
        req2: "Ý tưởng nội dung dạy (50–500 ký tự)",
        req3: "Vai trò và công ty",
        req4: "Số năm kinh nghiệm",
        req5: "CV (PDF)",
        req6: "Ít nhất 1 lĩnh vực",
        req7: "Ít nhất 1 kỹ năng",
      },
      years: {
        under1: "Dưới 1 năm",
        oneToTwo: "1–2 năm",
      ...
      form: {
        ...
        section3Title: "3. Ý tưởng về nội dung cần dạy",
        section4Title: "4. Tài liệu & liên kết",
        section5Title: "5. Chứng chỉ",
        section6Title: "6. Video giới thiệu",
        section7Title: "7. Bạn có thể dạy gì",
