  ...
  instructor: {
    ...
    application: {
      ...
      sidebar: {
        ...
        step2: "Đính kèm CV PDF",
        step3: "Chọn lĩnh vực và kỹ năng",
        step4: "Kiểm tra và nộp đơn",
        requiredTitle: "Bắt buộc",
        req1: "Vai trò và công ty",
        req2: "Số năm kinh nghiệm",
        req3: "CV (PDF)",
        req4: "Ít nhất 1 lĩnh vực",
        req5: "Ít nhất 1 kỹ năng",
      },
      years: {
        under1: "Dưới 1 năm",
        oneToTwo: "1–2 năm",
      ...
      form: {
        ...
        section2Title: "2. Tài liệu & liên kết",
        section3Title: "3. Chứng chỉ",
        section4Title: "4. Video giới thiệu",
        section5Title: "5. Bạn có thể dạy gì",
