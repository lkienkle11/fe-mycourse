...
const messages = {
  ...
  auth: {
    ...
    socialLogin: {
      ...
      discordSignup: "Sign up with Discord",
      googleSuccess: "Signed in with Google",
      googleCancelled: "Google sign-in was cancelled",
      xSuccess: "Signed in with X",
      xCancelled: "X sign-in was cancelled",
      discordSuccess: "Signed in with Discord",
      discordCancelled: "Discord sign-in was cancelled",
    },
    email: "Email Address",
    password: "Password",
    fullName: "Full Name",
  ...
  instructor: {
    validation: {
      ...
      teachingContentIdeas: "Please enter your teaching content ideas.",
      teachingContentIdeasMin:
        "Teaching content ideas must be at least 50 characters.",
      teachingContentIdeasMax:
        "Teaching content ideas must be at most 500 characters.",
    ...
    application: {
      ...
      sidebar: {
        ...
        step2: "Describe your experience and course ideas",
        step3: "Attach a PDF CV",
        step4: "Choose topics and skills you can teach",
        step5: "Review and submit",
        requiredTitle: "Required",
        req1: "Bio (≥ 100 characters)",
        req2: "Teaching content ideas (50–500 characters)",
      ...
      form: {
        ...
        section3Title: "3. Teaching content ideas",
        section4Title: "4. Documents & links",
        section5Title: "5. Certificates",
        section6Title: "6. Intro video",
        section7Title: "7. What you can teach",
        optional: "Optional",
        ...
        certOr: "or",
        certPdfLabel: "Certificate PDF",
        certPdfEmpty: "No certificate PDF selected",
        chooseCertPdf: "Choose PDF",
        certPdfOnly: "Only PDF files are allowed.",
      },
      confirm: {
        title: "Confirm submission",
        description:
          "Your application will be reviewed. Please carefully double-check all your information before submitting.",
