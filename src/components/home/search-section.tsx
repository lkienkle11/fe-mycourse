...
import { Search, Code, Palette, LineChart, Briefcase, Camera, Music } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto -mt-24 bg-card rounded-3xl p-6 md:p-8 shadow-2xl border border-border">
          ...
          <div className="mt-8 flex flex-col items-center">
            <p className="text-sm font-medium text-muted-foreground mb-4 uppercase tracking-wider">{t("popularCategories")}</p>
