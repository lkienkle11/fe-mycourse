        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative aspect-[4/3] w-full rounded-2xl bg-slate-100 border overflow-hidden group">
                ...
                <div className="absolute inset-0 flex items-center justify-center text-muted-foreground/50">
                  <span className="font-medium text-lg">Promo Image Placeholder</span>
                </div>
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl mb-6">
              {t("promoTitle1")} <span className="text-primary underline decoration-wavy decoration-primary/50 underline-offset-4">{t("promoTitle2")}</span> {t("promoTitle3")}
            </h2>
              ...
              {[
                ...
                return (
                  <li key={index} className="flex gap-4">
                    ...
                    <span className="text-foreground font-medium">{t(item.textKey)}</span>
                  </li>
                );
              })}
            </ul>
