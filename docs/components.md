...
`src/components/features/instructor/` — instructor management + instructor route glue: `InstructorProfileViewDialog`, `InstructorRosterPickerDialog`, `InstructorApprovalActions`. **Planned (ADM):** `InstructorUserCell`, `PreviewPDF`, full application detail modal. **Planned (user page):** become-instructor form sections, combobox wrappers, `ApplicationSidebar`. See `docs/instructor-admin.md`, `docs/instructor-application.md`.
