...
│   └── use-register-dashboard-page-header.ts
├── events/
...
│   ├── instructor-items.ts
│   ├── page-header.ts      # DASHBOARD_ROLE_ROOT + DASHBOARD_PAGE_HEADER_ROUTES (title/description route registry; breadcrumbs derived from nav items)
