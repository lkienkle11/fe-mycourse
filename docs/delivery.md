...
Index of **non-REST** realtime channels exposed to the browser. REST / Xior-backed Fetch usage remains in [`api-using.md`](./api-using.md) and [`api-overview.md`](./api-overview.md).
