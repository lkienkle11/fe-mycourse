...
docker build \
  ...
  --build-arg "NEXT_PUBLIC_X_CLIENT_ID=${NEXT_PUBLIC_X_CLIENT_ID:-}" \
  --build-arg "NEXT_PUBLIC_X_CALLBACK_URL=${NEXT_PUBLIC_X_CALLBACK_URL:-}" \
  --build-arg "NEXT_PUBLIC_DISCORD_CLIENT_ID=${NEXT_PUBLIC_DISCORD_CLIENT_ID:-}" \
  --build-arg "NEXT_PUBLIC_DISCORD_CALLBACK_URL=${NEXT_PUBLIC_DISCORD_CALLBACK_URL:-}" \
  -t "$IMAGE_TAG" \
